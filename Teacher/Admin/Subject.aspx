<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.master" AutoEventWireup="true" CodeFile="Subject.aspx.cs" Inherits="Admin_Subject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="#">Subject</a>
            </li>
    ...
    <!--== DASHBOARD INFO ==-->
    <div class="sb2-2-1">
        <h2><i class="fa fa-book"></i>List of Subject</h2>
        <div class="db-2">
            ...
            <div class="row">
                ...
                <div class="col-md-12" style="padding-bottom: 10px; border-bottom: 1px solid #ccc">
                    ...
                    <asp:HyperLink ID="Button1" runat="server" Style="float: right" CssClass="btn btn-primary " NavigateUrl="~/Admin/AddSubject.aspx">
                       <i class="fa fa-plus"></i>
                       Add Subject</asp:HyperLink>
                </div>
                <hr />
                ...
                <div class="col-md-12 table-responsive table-desi">
                    ...
                    <asp:GridView ID="bindGridSubject" CssClass="col-sm-12 table" ShowHeaderWhenEmpty="true" runat="server" AutoGenerateColumns="False" OnRowEditing="bindGridSubject_RowEditing" OnRowCancelingEdit="bindGridSubject_RowCancelingEdit" OnRowUpdating="bindGridSubject_RowUpdating" OnRowDeleting="bindGridSubject_RowDeleting">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Subject Code" Visible="false">
                                ...
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# Bind("subjectCode") %>' ID="Label2subjectCode"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Subject Name">
                                <EditItemTemplate>
                                    <asp:TextBox runat="server" Text='<%# Bind("subjectName") %>' ID="txtsubjectName"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# Bind("subjectName") %>' ID="Label3subjectName"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
